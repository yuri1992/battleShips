...
public class GameManagerFactory {
    ...
    static private List<Player> parsePlayers(List<Board> playerList, List<ShipType> types, int boardSize, int mines)
        ...
        for (int i = 0; i < playerList.size(); ++i) {
            ...
            List<engine.model.ships.Ship> ships = new ArrayList<>();
    ...
    static private void validateShipDirections(List<engine.model.ships.Ship> ships) throws GameSettingsInitializationException {
        for (Ship ship : ships) {
